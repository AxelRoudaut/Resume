...
%---------------------------------------------------------------------------------------------------
{\Huge\bfseries\color{accent}Axel Roudaut}\hspace{0.7em}{\large\color{ink}Ingénieur DevSecOps — Platform \& Data}\\[3pt]
{\small\color{muted}%
...
%---------------------------------------------------------------------------------------------------
\section{Résumé}
Ingénieur DevSecOps, 7+ ans en conception et exploitation d'infrastructures distribuées en
environnements air-gap renforcés (Thales, Ministère des Armées). Expertise CI/CD, plateformes Kubernetes,
automatisation VMware, supervision (Prometheus, Grafana) et pipelines de traitement Kafka à grande échelle ; montée en compétences sur l'infrastructure
IA et l'inférence LLM (vLLM). Ouvert à des postes DevOps, SRE, Platform et Data Engineering à Montpellier ou en full remote
dès octobre 2026.
...
\skillrow{Environnements sécurisés}{Réseaux air-gap, gestion des secrets (Ansible Vault), analyse de sécurité CI/CD}
...
\cventry{Platform Engineer --- Produits de cybersécurité}{Thales}{Rennes, France}{02/2022 -- présent}
\begin{itemize}
...
\cventry{Data \& DevOps Engineer --- Supervision de sécurité (SIEM)}{Ministère des Armées}{Paris, France}{02/2019 -- 02/2022}
\begin{itemize}
