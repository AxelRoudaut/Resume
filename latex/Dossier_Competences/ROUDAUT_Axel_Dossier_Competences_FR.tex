...
DevSecOps et Data Engineer dans le domaine de la cybersécurité avec \textbf{7+ ans d'expérience} dans la conception et l'exploitation d'infrastructures distribuées et sécurisées (Thales, Ministère des Armées). Spécialisé en automatisation CI/CD, orchestration de services et déploiement de plateformes de traitement de données. Ouvert à des postes DevOps, Data Engineering et Platform Engineering à \textbf{Montpellier} à partir d'\textbf{octobre 2026}.
